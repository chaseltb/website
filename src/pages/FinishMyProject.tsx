      ...
      <main className="pt-32">
          ...
          <div className="container">
            <div className="max-w-5xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-16">
                <a href="#contact" className="btn btn-primary text-lg px-10 py-4 w-full sm:w-auto group shadow-[0_0_30px_rgba(168,85,247,0.5)] hover:shadow-[0_0_40px_rgba(168,85,247,0.7)] transition-all duration-300">
              ...
              {/* Industries */}
              <div className="glass p-8 rounded-2xl border border-neutral-800/50 shadow-[0_0_25px_rgba(168,85,247,0.2)]">
          ...
          <div className="container">
            ...
            <div className="grid md:grid-cols-3 gap-10">
              {benefits.map((benefit, index) => (
                <div key={index} className="card group flex flex-col h-full shadow-[0_0_30px_rgba(168,85,247,0.25)] hover:shadow-[0_0_40px_rgba(168,85,247,0.4)] transition-all duration-500">
          ...
          <div className="container">
            ...
            <div className="grid md:grid-cols-3 gap-10">
              {process.map((step, index) => (
                <div key={index} className="card relative group shadow-[0_0_30px_rgba(168,85,247,0.25)] hover:shadow-[0_0_40px_rgba(168,85,247,0.4)] transition-all duration-500">
          ...
          <div className="container">
            ...
            <div className="grid md:grid-cols-3 gap-10">
              {testimonials.map((testimonial, index) => (
                <div key={index} className="card shadow-[0_0_30px_rgba(168,85,247,0.25)] hover:shadow-[0_0_40px_rgba(168,85,247,0.4)] transition-all duration-500">
        ...
        <section id="contact" className="section section-light">
          <div className="container relative z-10">
            <div className="max-w-5xl mx-auto card relative overflow-hidden shadow-[0_0_35px_rgba(168,85,247,0.3)] hover:shadow-[0_0_45px_rgba(168,85,247,0.5)] transition-all duration-500">
              ...
              <form className="max-w-lg mx-auto space-y-8 relative z-10">
                ...
                <button
                  type="submit"
                  className="w-full btn btn-primary py-5 text-lg flex items-center justify-center gap-3 group shadow-[0_0_30px_rgba(168,85,247,0.5)] hover:shadow-[0_0_40px_rgba(168,85,247,0.7)] transition-all duration-300"
                >
                  Finish My Site Now
                  <CaretRight className="h-5 w-5 group-hover:translate-x-1 transition-transform duration-300" weight="bold" />
                </button>
